      ...
      <Page size="FOLIO" orientation="landscape" style={styles.pageLandscape}>
        ...
        <View style={{ flexDirection: 'column', alignItems: 'center', marginBottom: 15 }}>
          ...
          <View style={{ alignItems: 'center', marginBottom: 5 }}>
            ...
            <Text style={{ fontSize: 11, fontWeight: 'bold', textAlign: 'center', lineHeight: 1.2 }}>KELOMPOK PKK RT</Text>
          </View>
          ...
          <View style={{ width: 220, marginTop: 5 }}>
            <View style={{ flexDirection: 'row', marginBottom: 2 }}>
              ...
              <Text style={{ fontSize: 8, fontWeight: 'bold', flex: 1 }}>{info?.nomor_rt || '-'}</Text>
            </View>
            <View style={{ flexDirection: 'row', marginBottom: 2 }}>
        ...
        <View style={[styles.table, { width: 861 }]}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={[styles.tableColHeader, { width: 100, height: 100 }]}><Text style={styles.tableCellHeader}>NAMA KELOMPOK DASA WISMA</Text></View>
          ...
          {items.map((row: any, idx: number) => (
            <View key={idx} style={styles.tableRow}>
              ...
              <View style={[styles.tableCol, { width: 100 }]}><Text style={styles.tableCell}>{row.nama_dasawisma?.toUpperCase()}</Text></View>
