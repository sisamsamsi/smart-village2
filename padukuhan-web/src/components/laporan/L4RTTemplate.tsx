    ...
    <Document>
      <Page size="FOLIO" orientation="landscape" style={styles.pageLandscape}>
        ...
        <View style={styles.judulContainer}>
          <Text style={styles.judul}>REKAPITULASI CATATAN DATA WARGA TINGKAT RT</Text>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={[styles.tableColHeader, { width: 80 }]}><Text style={styles.tableCellHeader}>NAMA KELOMPOK DASA WISMA</Text></View>
          ...
          {items.map((row: any, idx: number) => (
            <View key={idx} style={styles.tableRow}>
              ...
              <View style={[styles.tableCol, { width: 80 }]}><Text style={styles.tableCell}>{row.nama_dasawisma?.toUpperCase()}</Text></View>
