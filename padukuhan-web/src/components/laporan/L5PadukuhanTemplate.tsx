      ...
      <Page size="FOLIO" orientation="landscape" style={styles.pageLandscape}>
        ...
        <View style={{ flexDirection: 'column', alignItems: 'center', marginBottom: 15 }}>
          ...
          <View style={{ alignItems: 'center', marginBottom: 5 }}>
            ...
            <Text style={{ fontSize: 11, fontWeight: 'bold', textAlign: 'center', lineHeight: 1.2 }}>KELOMPOK PKK TINGKAT PADUKUHAN</Text>
          </View>
          
          {/* Metadata View */}
          <View style={{ width: 220, marginTop: 5 }}>
            <View style={{ flexDirection: 'row', marginBottom: 2 }}>
              <Text style={{ fontSize: 8, width: 90 }}>PADUKUHAN</Text>
              <Text style={{ fontSize: 8, width: 10 }}>:</Text>
              <Text style={{ fontSize: 8, fontWeight: 'bold', flex: 1 }}>MANDINGAN</Text>
            </View>
            <View style={{ flexDirection: 'row', marginBottom: 2 }}>
        ...
        <View style={[styles.table, { width: 841 }]}>
          {/* Header Baris */}
          <View style={styles.tableRow}>
            <View style={[styles.tableColHeader, { width: 20, height: 100 }]}><Text style={styles.tableCellHeader}>NO</Text></View>
            <View style={[styles.tableColHeader, { width: 55, height: 100 }]}><Text style={styles.tableCellHeader}>NOMOR RT</Text></View>
            <VerticalHeaderCell width={25} height={100} text="JML DW" />
          ...
          {items.map((row: any, idx: number) => (
            <View key={idx} style={styles.tableRow}>
              ...
              <View style={[styles.tableCol, { width: 55 }]}><Text style={styles.tableCellCenter}>{row.nomor_rt}</Text></View>
